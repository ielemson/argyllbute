...
<meta name="keywords" content="Argyll and Bute, energy solutions, oil and gas, renewable energy, engineering services, sustainability, infrastructure, industrial services">
<meta name="description" content="Argyll and Bute Ltd delivers innovative energy, engineering, and infrastructure solutions across oil, gas, and renewable sectors with a commitment to sustainability and excellence.">
...
<meta property="og:description" content="Delivering reliable oil, gas, and renewable energy solutions with innovation, sustainability, and technical excellence.">
...
<meta name="twitter:description" content="Reliable energy and infrastructure solutions across oil, gas, and renewables.">
            ...
            <div class="col-lg-6 mt-2-2 mt-sm-12 mt-lg-1-9 wow fadeIn" data-wow-delay="300ms">
                <div class="ps-lg-1-9 ps-xl-10">
                    ...
                    <div class="section-title-01 mb-1-9">
                        <span class="text-secondary text-uppercase small letter-spacing-4 d-block mb-2 font-weight-600">
                            About Us
                        </span>
                        <h2 class="mb-0 h1">
                ...
                <div>
                    <div class="row mt-n1-9">
                        <div class="col-7 mt-1-9">
                            <div class="mb-1-9">
                                <img src="img/content/why-choose-04.jpg" alt="Energy infrastructure solutions" class="w-100">
                            </div>
                            <div>
                                <img src="img/content/why-choose-05.jpg" alt="Renewable energy systems" class="w-100">
                            </div>
                        </div>
                        <div class="col-5 mt-1-9">
                            <img src="img/content/why-choose-06.jpg" alt="Engineering excellence" class="h-100 w-100 object-fit-cover">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="d-flex mb-1-9">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="mb-0 text-white opacity7">
                                With deep experience across oil, gas, and renewable energy, we deliver innovative, 
    ...
    <div class="container">
        ...
        <div class="row g-xl-5 mt-n1-9">
            ...
            @forelse($services as $index => $service)
                <div class="col-md-6 col-lg-4 mt-1-9 wow fadeIn" data-wow-delay="{{ 200 + ($index * 200) }}ms">
                    ...
                    <div class="card-style-06 h-100">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="service-icon">
                                <i class="{{ $service->icon ?? 'flaticon-042-solar-panel' }}"></i>
                            </div>
                        </div>
